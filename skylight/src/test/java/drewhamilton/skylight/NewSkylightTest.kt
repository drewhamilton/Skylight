...
class NewSkylightTest {
    ...
    private val testAlwaysDaytime = NewSkylightDay.AlwaysDaytime(testDate)
    private val testAlwaysLight = NewSkylightDay.AlwaysLight(testDate, testSunrise, testSunset)
    private val testNeverLight = NewSkylightDay.NeverLight(testDate)
    private val testNeverDaytime = NewSkylightDay.NeverDaytime(testDate, testDawn, testDusk)
    private val testTypical = NewSkylightDay.Typical(testDate, testDawn, testSunrise, testSunset, testDusk)
    ...
    private fun mockSkylight(skylightDay: NewSkylightDay) {
        mockSkylight = mock {
